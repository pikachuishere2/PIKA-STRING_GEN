...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Devotxion"))
        else:
            ...
            await client.join_chat("@LOVE_VERSEEE")
    except KeyError:
        pass
    try:
