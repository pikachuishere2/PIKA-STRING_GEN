...
from FADEDSTRING.utils import retry_key
...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@PikaBotUodates"))
        else:
            ...
            await client.join_chat("@PikaBotUpdates")
    except KeyError:
        pass
    try:
