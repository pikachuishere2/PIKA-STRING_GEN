...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@PROFESSOR_77XX"))
        else:
            ...
            await client.join_chat("@PROFESSOR_77XX")
    except KeyError:
        pass
    try:
